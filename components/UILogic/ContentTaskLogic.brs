...
sub RunContentTask(practiceId as String)
    print "parameter"; practiceId
    ...
    m.contentTask.practiceId = practiceId
...
sub OnMainContentLoaded() ' invoked when content is ready to be used
    ...
    ' m.LoginScreen.practiceId = m.contentTask.practiceId 
    ' print "onContentLoaded"; m.LoginScreen
    showPlaylistReadyScreen(m.contentTask.practiceId)
end sub